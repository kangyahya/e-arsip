                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input id="ctrl-username"  value="<?php  echo $this->set_field_value('username',""); ?>" type="password" placeholder="Enter Username" maxlength="255"  required="" name="username"  data-url="api/json/user_username_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  password password-strength ctrl-check-duplicate" />
