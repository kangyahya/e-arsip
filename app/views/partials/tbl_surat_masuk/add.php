            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="tbl_surat_masuk-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("tbl_surat_masuk/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-no_surat"  value="<?php  echo $this->set_field_value('no_surat',""); ?>" type="number" placeholder="Enter No Surat" step="1"  required="" name="no_surat"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
