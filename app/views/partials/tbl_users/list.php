    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('tbl_users'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('tbl_users'); ?>">
            ...
            <div class="container">
                <div class="row ">
                    <div class="col-sm-3 comp-grid">
                        ...
                        <a href="<?php print_link("tbl_users/add") ?>"  class="btn btn btn-primary my-1 open-page-modal">
                    ...
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated pulse page-content">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-user_role_id">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/tbl_users_user_role_id_option_list'); ?>' 
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <?php if($can_delete){ ?>
                                                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("tbl_users/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
